...
<link rel="stylesheet"
	href="<c:url value="/resources/css/product_detail.css" />">
...
<body>
	...
	<div id="wrap" class="wrap" name="wrap">
		...
		<!-- 첫째줄 시작-->
		<div id="info_box" class="box_1" name="info_box">

			<!-- 기본 차 사진 시작-->
			<div id="picture_main" class="picture_1" name="picture_main">
				<img src="<spring:url value='/resources/image/post1.jpg'/>" />
			</div>
			<!-- 기본 차 사진 끝-->

			<!-- 차 설명 시작-->
			<div id="info_detail" class="info_detail" name="info_detail">
				<div id="info_title" class="info_title" name="info_title">
					<c:out value="${productDetail.productName}" />
				</div>
				<div id="title_11" class="title_1" name="title_11">
					차종 : <span id="text_11" class="text_1" name="text_11"> <c:out
							value="${productDetail.productSize}" /></span>
				</div>
				<div id="title_12" class="title_1" name="title_12">
					분류 : <span id="text_12" class="text_1" name="text_12"> <c:out
							value="${productDetail.productType}" /></span>
				</div>
				<div id="title_13" class="title_1" name="title_13">
					가격 : <span id="text_13" class="text_1" name="text_13"> <c:out
							value="${productDetail.productPrice}" /></span>
				</div>
				<div id="title_14" class="title_1" name="title_14">
					연비 : <span id="text_14" class="text_1" name="text_14"> <c:out
							value="${productDetail.productEfficient}" /></span>
				</div>
				<div id="title_15" class="title_1" name="title_15">
					유종 : <span id="text_15" class="text_1" name="text_15"> <c:out
							value="${productDetail.productFuel}" /></span>
				</div>
				<div id="title_16" class="title_1" name="title_16">
					코드 : <span id="text_16" class="text_1" name="text_16"> <c:out
							value="${productDetail.productCode}" /></span>
				</div>
			</div>
			<!---- 차 설명 끝 -->
		</div>
		...
		<!-- VR 시작-->
		<div id="picture_vr" class="picture_2" name="picture_vr">
			<img src="<spring:url value='/resources/image/post1.jpg'/>" />
		</div>
		<!-- VR 시작-->

		<!-- 큰 차 사진 시작-->
		<div id="picture_detail" class="picture_3" name="picture_detail">
			<img src="<spring:url value='/resources/image/post1.jpg'/>" />
		</div>
		<!-- 큰 차 사진 시작-->

		<!-- 옵션 전체 시작-->
		<div id="option_box" class="box_2" name="option_box">
			<!-- 옵션 제목 시작-->
			<div id="option_title" class="option_title" name="option_title">
				<span class="material-icons"> double_arrow </span> 옵션 선택
			</div>
			<!-- 옵션 제목 끝 -->

			<!-- 색상 선택 시작-->
			<div id="option_color" class="option_color" name="option_color">
				색상 선택
				<!-- 라디오 시작-->
				<div>
			...
			<div id="option_select" class="box_3" name="option_select">
				...
				<div id="option_select_1" class="option_select_n"
					...
					<div id="option_1_title" class="option_n_title"
						name="option_1_title">BASIC</div>
					<!-- 옵션 1번 박스 제목 끝-->

					<!-- 옵션 1번 박스 내용 시작-->
					<div id="option_1_text" class="option_n_text" name="option_1_text">
						<div id="title_1_11" class="title_2" name="title_1_11">
							타이어 : <span id="text_1_11" class="text_2" name="text_1_11">캐딜락</span>
						</div>
						<div id="title_1_12" class="title_2" name="title_1_12">
							휠 : <span id="text_1_12" class="text_2" name="text_1_12">캐딜락</span>
						</div>
						<div id="title_1_13" class="title_2" name="title_1_13">
							네비게이션 : <span id="text_1_13" class="text_2" name="text_1_13">캐딜락</span>
						</div>
						<div id="title_1_14" class="title_2" name="title_1_14">
							시트 : <span id="text_1_14" class="text_2" name="text_1_14">캐딜락</span>
						</div>
						<div id="title_1_15" class="title_2" name="title_1_15">
							프레임 : <span id="text_1_15" class="text_2" name="text_1_15">캐딜락</span>
						</div>
						<div id="title_1_16" class="title_2" name="title_1_16">
							창문 : <span id="text_1_16" class="text_2" name="text_1_16">캐딜락</span>
						</div>
					</div>
					<!-- 옵션 1번 박스 내용 끝-->
				...
				<div id="option_select_2" class="option_select_n"
					...
					<div id="option_2_title" class="option_n_title"
						name="option_2_title">ULTRA</div>
					<!-- 옵션 2번 박스 제목 끝-->

					<!-- 옵션 2번 박스 내용 시작-->
					<div id="option_2_text" class="option_n_text" name="option_2_text">
						<div id="title_2_11" class="title_2" name="title_2_11">
							타이어 : <span id="text_2_11" class="text_2" name="text_2_11">캐딜락</span>
						</div>
						<div id="title_2_12" class="title_2" name="title_2_12">
							휠 : <span id="text_2_12" class="text_2" name="text_2_12">캐딜락</span>
						</div>
						<div id="title_2_13" class="title_2" name="title_2_13">
							네비게이션 : <span id="text_2_13" class="text_2" name="text_2_13">캐딜락</span>
						</div>
						<div id="title_2_14" class="title_2" name="title_2_14">
							시트 : <span id="text_2_14" class="text_2" name="text_2_14">캐딜락</span>
						</div>
						<div id="title_2_15" class="title_2" name="title_2_15">
							프레임 : <span id="text_2_15" class="text_2" name="text_2_15">캐딜락</span>
						</div>
						<div id="title_2_16" class="title_2" name="title_2_16">
							창문 : <span id="text_2_16" class="text_2" name="text_2_16">캐딜락</span>
						</div>
					</div>
					<!-- 옵션 2번 박스 내용 끝-->
				...
				<div id="option_select_3" class="option_select_n"
					...
					<div id="option_3_title" class="option_n_title"
						name="option_3_title">NORMAL</div>
					<!-- 옵션 3번 박스 제목 끝-->

					<!-- 옵션 3번 박스 내용 시작-->
					<div id="option_3_text" class="option_n_text" name="option_3_text">
						<div id="title_3_11" class="title_2" name="title_3_11">
							타이어 : <span id="text_3_11" class="text_2" name="text_3_11">캐딜락</span>
						</div>
						<div id="title_3_12" class="title_2" name="title_3_12">
							휠 : <span id="text_3_12" class="text_2" name="text_3_12">캐딜락</span>
						</div>
						<div id="title_3_13" class="title_2" name="title_3_13">
							네비게이션 : <span id="text_3_13" class="text_2" name="text_3_13">캐딜락</span>
						</div>
						<div id="title_3_14" class="title_2" name="title_3_14">
							시트 : <span id="text_3_14" class="text_2" name="text_3_14">캐딜락</span>
						</div>
						<div id="title_3_15" class="title_2" name="title_3_15">
							프레임 : <span id="text_3_15" class="text_2" name="text_3_15">캐딜락</span>
						</div>
						<div id="title_3_16" class="title_2" name="title_3_16">
							창문 : <span id="text_3_16" class="text_2" name="text_3_16">캐딜락</span>
						</div>
					</div>
					<!-- 옵션 3번 박스 내용 끝-->
