...
CREATE TABLE member_tbl (
  ...
  member_password VARCHAR2(20) CONSTRAINT member_tbl_password_nn NOT NULL,
...
ALTER TABLE member_tbl MODIFY (member_password CONSTRAINT member_tbl_password_nn NOT NULL);
...
COMMENT ON COLUMN member_tbl.member_password IS '패쓰워드';
