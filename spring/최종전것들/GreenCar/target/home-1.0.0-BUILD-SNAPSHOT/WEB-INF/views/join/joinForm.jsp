			...
			<table id="join_form" class="join_form">
				...
				<tr>
					...
					<td class="td2"><input type="email" id="userEmail"
						class="member_field" name="userEmail" size="40" maxlength="50"
						required></td>
				...
				<tr>
					<td class="td1"></td>
					<td class="td2"></td>
					<td class="td3"><span class="required_2">* 영소문자 숫자 조합하여
							8~20자리 입력.</span></td>
					<td class="td2"></td>
				</tr>
				...
				<tr>
					...
					<td class="td2"><input type="text" id="userNick"
						class="member_field" name="userNick" maxlength="10" size="40"
						required></td>
				...
				<tr>
					<td class="td1"></td>
					<td class="td2"></td>
					<td class="td3"><span class="required_2">* 영문/한글/숫자 2자
							이상 입력.</span></td>
					<td class="td2"></td>
				</tr>
				...
				<tr>
					...
					<td class="td2"><input type="text" id="userAddress"
						class="member_field" name="userAddress" maxlength="100" size="40"></td>
