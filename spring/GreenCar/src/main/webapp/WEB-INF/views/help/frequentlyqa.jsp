...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/css/frequentlyqa.css" />">
...
<body>
    ...
    <aside class="mypage">   
        ...
        <ul>내가쓴 글 보기<span id="howMuch"> 5</span></ul>
        <ul>회원탈퇴</ul>
    ...
    <section><!--네모 상자-->
        <div id="top_button_box">
            ...
            <button id="others" onclick="location.href='/help/frequentlyqaByCate?freCategory=[기타]'">기타</button>
        </div>
        <!-- -------------------------------------- -->
