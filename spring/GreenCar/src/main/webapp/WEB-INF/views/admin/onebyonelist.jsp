...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/css/onebyonelist.css" />">
            ...
            <table>
                ...
                <c:forEach items="${onebyonelist}" var="list">
						<tr>
							...
							<td>
								<a href="/admin/onebyoneview?oboNo=${list.oboNo}"><c:out value="${list.oboTitle}"></c:out></a>
							</td>
							<td><c:out value="${list.oboWriter}" /></td>
							<td><fmt:formatDate value="${list.oboDate}" pattern="yyyy-MM-dd"/></td>
						</tr>
				</c:forEach>
            </table>
        </div>
