		...
		<section id="section_background">
			...
			<div id="section_loginbox">
				...
				<form method="POST" action="/login">
					...
					<div>
						<!--id,pw입력영역-->
						<input type="text" name="username" id="id_box"> <input
							type="password" name="password" id="pw_box">
						<h5 class="msg">
							<c:out value="${error }" />
						</h5>
						<h5 class="msg">
					...
					<div id="login_mid">
						<!--아이디,비밀번호찾기 영역-->
						<a href="/login/searchIdPw">아이디|비밀번호 찾기</a> <a
							href="/join/joinForm"><span>회원가입</span></a>
					</div>
					<div id="login_bottom">
						<div>
