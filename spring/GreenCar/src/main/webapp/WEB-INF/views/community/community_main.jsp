    ...
    <div class="wrap">
        ...
        <table class="notice_borad">
            ...
            <c:forEach items="${list}" var="commu">
	            <tr>
	            	<td><c:out value="${commu.commuNo}" /></td>
	            	<td>
	            	<a href='/community/community_read?commuNo=<c:out value="${commu.commuNo}"/>'>
	            	<c:out value="${commu.commuTitle}" /></a>
	            	</td>
	            	<td><c:out value="${commu.commuWriter}" /></td>
	            	<td><fmt:formatDate pattern="yyyy-MM-dd" value="${commu.commuDate}" /></td>
	            	<td><c:out value="${commu.commuView}" /></td>
	            </tr>            
            </c:forEach>
        	</table>
        	...
        	<!-- 검색기능 -->
        	<div>
	        	<form id="searchForm" action="/community/community_main" method="GET">
	        		<select name="type">
